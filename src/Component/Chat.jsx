...
//   return (
//     <div>
//        <div className="max-w-md mx-auto my-10 bg-white p-4 h-96 rounded-md shadow-md">
//         <div className='bg-gray-500 w-full h-12 mb-2'>

//         </div>
//       {/* Sender's message */}
//       <div className="flex justify-end mb-2">
//         <div className="bg-green-500 text-white p-2 rounded-tl-lg rounded-bl-lg rounded-br-lg max-w-3/4">
//           Hello, this is a sender's message.
//         </div>
//       </div>

//       {/* Receiver's message */}
//       <div className="flex mb-2">
//         <div className="bg-gray-300 p-2 rounded-tr-lg rounded-bl-lg rounded-br-lg max-w-3/4">
//           Hi, this is a receiver's message.
//         </div>
//       </div>
